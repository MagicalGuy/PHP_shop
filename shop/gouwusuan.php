...
<table width="766" height="438" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="557" align="center" valign="top" bgcolor="#FFFFFF">       <script language="javascript">
		...
		function get_type(){
			var a = document.getElementById("zfff");
			var b = document.getElementById("bank");
			
			
			if(a.selectedIndex=="0"){
				b.innerHTML = "工商银行";
				b.href="https://mybank.icbc.com.cn/icbc/perbank/index.jsp";
			}
			if(a.selectedIndex=="1"){
				b.innerHTML = "建设银行";
				b.href="http://www.ccb.com/";
			}
			if(a.selectedIndex=="2"){
				b.innerHTML = "邮政";
				b.href="http://www.psbc.com/portal/zh_CN/index.html";
			}
			if(a.selectedIndex=="3"){
				b.innerHTML = "支付宝";
				b.href="https://auth.alipay.com/login/index.htm";
			}
			}
		 </script>
        ...
        <td height="295"><table width="530" height="293" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <form name="form1" method="post" action="savedd.php" onSubmit="return chkinput(this)">
              ...
              <tr>
                ...
                <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                    <select name="zfff" id="zfff" onchange="get_type();">
                  ...
                  转到：<a id="bank" href="https://mybank.icbc.com.cn/icbc/perbank/index.jsp">工商银行</a> </div></td>
              </tr>
              <tr>
